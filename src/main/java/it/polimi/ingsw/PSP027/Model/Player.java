...
public class Player {
    ...
    private List<GodCard> opponentGods;
    ...
    public Player() {
        ...
        opponentGods = new ArrayList<GodCard>();
    ...
    public void setOpponentGod(GodCard opponentGod) {
        opponentGods.add(opponentGod);
    }
     ...
     * influenced by its opponent's gods unless they need to (in that case their god will be readded to the list with setOpponentGod()
     */

    public void removeOpponentGods() {
        opponentGods.clear();
    }
    ...
    public List<GodCard> getOpponentGods() {
        return opponentGods;
    }
