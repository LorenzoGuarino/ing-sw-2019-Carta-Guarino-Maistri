...
public class GUI extends Application implements Runnable, ClientObserver {
    ...
    private GUI.GUIConnectionState connstate = GUI.GUIConnectionState.gui_undetermined;
    private GUI.GUIGameState gamestate = GUI.GUIGameState.gui_Deregistered;
                ...
                case gui_Connected: {
                    ...
                    if (chosen_cmd.length != 0) {
                        ...
                        /* *************************** GAME RELATED COMMANDS *************************** */
                            ...
                            if (chosen_cmd.length == 2) {
                                gamestate = GUI.GUIGameState.gui_WaitForSomethingToHappen;
    ...
    public void OnConnected() {
        connstate = GUI.GUIConnectionState.gui_Connected;
    }
    ...
    public void OnConnectionError() {
        connstate = GUI.GUIConnectionState.gui_disconnected;
    ...
    public void OnRegistered() {
        gamestate = GUI.GUIGameState.gui_Registered;
    }
    ...
    public void OnChooseGods(int requiredgods, List<String> gods) {
        gamestate = GUI.GUIGameState.gui_ChoosingGods;
    ...
    public void OnChooseGod(List<String> chosengods) {
        gamestate = GUI.GUIGameState.gui_ChoosingGod;
    ...
    public void OnChooseFirstPlayer(List<String> players) {
        gamestate = GUI.GUIGameState.gui_ChoosingFirstPlayer;
    ...
    public void OnChooseWorkerStartPosition(NodeList nodes) {
        gamestate = GUI.GUIGameState.gui_ChoosingWorkersStartPosition;
    ...
    public void OnChooseWorker(Node board) {
        gamestate = GUI.GUIGameState.gui_ChoosingWorker;
    ...
    public void OnCandidateCellsForMove(NodeList nodes) {
        gamestate = GUI.GUIGameState.gui_CandidateCellsForMove;
    ...
    public void OnCandidateCellsForOptMove(NodeList nodes) {
        gamestate = GUI.GUIGameState.gui_CandidateCellsForOptMove;
    ...
    public void OnCandidateCellsForBuild(NodeList nodes) {
        gamestate = GUI.GUIGameState.gui_CandidateCellsForBuild;
    ...
    public void OnCandidateCellsForOptBuild(NodeList nodes) {
        gamestate = GUI.GUIGameState.gui_CandidateCellsForOptBuild;
    ...
    public void OnCandidateCellsForOptEnd(NodeList nodes) {
        gamestate = GUI.GUIGameState.gui_CandidateCellsForOptEnd;
    ...
    public void OnPrintUpdatedBoard(NodeList nodes) {
        gamestate = GUI.GUIGameState.gui_PrintingUpdatedBoard;
