...
public class BoardPage_OptMoveController {
    ...
    @FXML
    public ImageView OptPhaseDescription;
    Image ArtemisOptMoveDescription = new Image("images/OptionalPhases/OptionalBuildAfterMove"); //TODO adding Artemis description image for optional move
    @FXML
    ...
    public void initialize() {
        ...
        OptPhaseDescription.setVisible(true);
    ...
    public void setPlayer1Panel(String god, String nickname, boolean playingPlayer, boolean deadPlayer, String url_icon) {
        if(playingPlayer) {
            ...
            if ("Artemis".equals(god)) {
                OptPhaseDescription.setImage(ArtemisOptMoveDescription);
            }
        }
        else {
