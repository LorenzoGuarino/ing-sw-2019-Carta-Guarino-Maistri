...
public class MovePhaseTest {
    ...
    public void changeCandidateMoves_workerCorneredInTopLeftWith4MovesPossible() {
        ...
        movePhase.changeCandidateCells();
        assertTrue(expectedList.containsAll(movePhase.getCandidateCells())
                && movePhase.getCandidateCells().containsAll(expectedList));
    }
